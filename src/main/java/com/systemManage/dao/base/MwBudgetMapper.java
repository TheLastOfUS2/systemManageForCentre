...
public interface MwBudgetMapper {
    /**
     * 根据条件查询记录总数
     */
     ...
     * 根据条件更新属性不为空的记录
     */
    int updateByExampleSelective(@Param("record") MwBudget record, @Param("example") Criteria example);

    /**
     * 根据条件更新记录
     */
    int updateByExample(@Param("record") MwBudget record, @Param("example") Criteria example);
     ...
     * 根据主键更新记录
     */
    int updateByPrimaryKey(MwBudget record);
}