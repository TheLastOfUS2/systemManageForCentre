...
{
  private static Service[] servicesAvailable = { WB.G(), yA.O(), l.E(), o.J(), dB.V(), PA.M(), IconManager.getIconManager() };
    ...
    throws Exception
  {
    ...
    {
      if (str2 == null)
        str2 = SessionDealWith.generateSessionIDWithCheckRegister(paramHttpServletRequest, paramHttpServletResponse);
    ...
    if ((ClusterConfigManager.getInstance().isUseCluster()) && (aB.A(paramHttpServletRequest, paramHttpServletResponse, str1, str2)))
      return;
    dealWeblet(str1, str2, paramHttpServletRequest, paramHttpServletResponse);
  }

  private static void dealWeblet(String paramString1, String paramString2, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    Weblet localWeblet;
    try
...
private static void dealWithoutOp(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    if (FRContext.isShouldForceEnglish())
      WebUtils.writeOutTemplate("/com/fr/web/core/deploySuccess_en_us.html", paramHttpServletResponse, localHashMap);
    else
      WebUtils.writeOutTemplate("/com/fr/web/core/deploySuccess.html", paramHttpServletResponse, localHashMap);
  }

  private static void dealWithOp(String paramString1, String paramString2, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    localPrintWriter.println("Unresolvable Operation:" + StableUtils.replaceScript4Xss(paramString1) + "  in class ReportDispatcher");
 ...
 * Qualified Name:     com.fr.web.core.ReportDispatcher
