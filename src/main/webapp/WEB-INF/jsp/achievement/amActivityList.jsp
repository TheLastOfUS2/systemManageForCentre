...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/amActivityList.js"></script>
<!-- 分页 -->
...
<body style="overflow-x : hidden;  overflow-y : hidden; ">
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'activityName'">活动名称</div>
						<div data-options="name:'activityTheme'">主题</div>
						<div data-options="name:'activityTime'">时间</div>
						<div data-options="name:'activitySpeaker'">主讲人</div>
					</div>
            	</td>
			</tr>
		</table>
	         	...
	         	<div id="ListForm" class="ListForm" style="text-align:left; width:95%;margin:0px auto; ">
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			<table id="Staff1" class="StaffInfo">
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>活动名称:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activityName' name='activityName' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>活动主题:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activityTheme' name='activityTheme' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'>
										<label class='in_label'>主讲人/主持人:</label>
									</td>
									<td width='180'>
										<input type='text' id='activitySpeaker' name='activitySpeaker' class='easyui-textbox'>
										<a id="a_activitySpeaker" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"activitySpeaker","")'>选择</a>
										<input type='hidden' id='activitySpeakerId' name='activitySpeakerId'>
									</td>
								...
								<tr>
									...
									<td width='180' colspan='3'>
									<input type='text' id='activityContent' name='activityContent' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<select id="fileType" name="fileType" style="padding: 3px;border: 1px solid #BDC7D8;">
											...
											<option value="0">文字讲稿或PPT</option>
											<option value="1">音像资料等</option>
    ...
    <div id="dlgUpload1-buttons">
       	...
       	<!-- <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgUpload1').dialog('close')" style="width:90px">取消</a> -->
