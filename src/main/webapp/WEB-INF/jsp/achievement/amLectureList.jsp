...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/amLectureList.js"></script>
<!-- 分页 -->
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"   style="overflow: hidden">
		  ...
		  <!-- 用户角色 -->
			...
			<input type="hidden" id="baseInfoName2" value="${accountInfo.baseInfoName}" />
			  ...
			  <input type="hidden" id="lectureDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'lectureTheme'">主题</div>
						<div data-options="name:'lectureSpeaker'">主讲人</div>
						<div data-options="name:'lectureTime'">时间</div>
						<div data-options="name:'lectureAddress'">地点</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none">
	         	<input type="text" id="lectureId" name="lectureId">
	         	<!-- 存放选择人员的文本框名称 -->
	         			...
	         			<table id="Staff1" class="StaffInfo">
	         				<tbody>
	         					<tr>
									...
									<input type='text' id='lectureTheme' name='lectureTheme' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'>
										<label class='in_label'>主讲人:</label>
									</td>
									<td width='180'>
										<input type='text' id='lectureSpeaker' name='lectureSpeaker' class='easyui-textbox'>
										<a id="a_lectureSpeaker" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"lectureSpeaker","")'>选择</a>
										<input type='hidden' id='lectureSpeakerId' name='lectureSpeakerId'>
									</td>
									<td width='120' style='text-align:right;'><label class='in_label'>时间:</label></td>
									<td width='180'>
									<input type='text' id='lectureTime' name='lectureTime' class='easyui-datebox'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>地点:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='lectureAddress' name='lectureAddress' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>主要内容:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='lectureContent' name='lectureContent' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='lectureRemarks' name='lectureRemarks'
