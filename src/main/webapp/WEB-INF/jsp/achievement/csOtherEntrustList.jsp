...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/csOtherEntrustList.js"></script>
<!-- 分页 -->
	...
	<table id="dg" title="其他委托列表"
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"   style="overflow: hidden">
		  ...
		  <!-- 用户角色 -->
		    ...
		    <input type="hidden" id="entrustDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'entrustUndertaker'">承担人</div>
						<div data-options="name:'entrustCompany'">委托单位</div>
						<div data-options="name:'entrustTime'">承担时间</div>
						<div data-options="name:'entrustTask'">委托任务</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none">
         		<input type="text" id="entrustId" name="entrustId">
         		<!-- 存放选择人员的文本框名称 -->
	         	...
	         	<div id="ListForm" class="ListForm" style="text-align:left; width:95%;margin:0px auto; ">
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			<table id="Staff1" class="StaffInfo">
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>委托任务:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='entrustTask' name='entrustTask' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>委托单位:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='entrustCompany' name='entrustCompany' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>承担人:</label></td>
									<td width='180'>
										<input type='text' id='entrustUndertaker' name='entrustUndertaker' class='easyui-textbox'>
										<a id="a_entrustUndertaker" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"entrustUndertaker","")'>选择</a>
										<input type='hidden' id='entrustUndertakerId' name='entrustUndertakerId'>
									</td>
									<td width='120' style='text-align:right;'><label class='in_label'>承担时间:</label></td>
									<td width='180'>
									<input type='text' id='entrustTime' name='entrustTime' class='easyui-datebox'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>简要说明:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='entrustSynopsis' name='entrustSynopsis' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='entrustRemarks' name='entrustRemarks'
