...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/pcTrainList.js"></script>
<!-- 分页 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'trainName'">培训人</div>
						<div data-options="name:'trainCompany'">组织单位</div>
						<div data-options="name:'trainTime'">培训时间</div>
						<div data-options="name:'trainAddress'">培训地点</div>
					</div>
            	</td>
			</tr>
		</table>
	         				...
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'>
										<label class='in_label'>培训人:</label>
									</td>
									<td width='180'>
										<input type='text' id='trainName' name='trainName' class='easyui-textbox'>
										<a id="a_trainName" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"trainName","")'>选择</a>
										<input type='hidden' id='trainNameId' name='trainNameId'>
									</td>
									<td width='120' style='text-align:right;'><label class='in_label'>培训时间:</label></td>
									<td width='180'>
									<input type='text' id='trainTime' name='trainTime' class='easyui-datebox'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>组织单位:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='trainCompany' name='trainCompany' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>培训地点:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='trainAddress' name='trainAddress' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>培训内容:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='trainContent' name='trainContent' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='trainRemarks' name='trainRemarks'
