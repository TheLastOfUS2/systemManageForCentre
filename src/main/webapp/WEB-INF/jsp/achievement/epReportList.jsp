...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/epReportList.js"></script>
<!-- 分页 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'reportTitle'">材料名称</div>
						<div data-options="name:'reportDept'">提交部门</div>
						<div data-options="name:'reportSubmitter'">提交人</div>
						<div data-options="name:'reportTime'">上报时间</div>
					</div>
            	</td>
			</tr>
		</table>
	...
	<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	...
         	<span style="display: none"><input type="text" id="reportType" name="reportType"></span>
         	<!-- 用来判断是弹窗是新增还是编辑 -->
	         	...
	         	<div id="ListForm" class="ListForm" style="text-align:left; width:95%;margin:0px auto; ">
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			<table id='Staff1' class='StaffInfo'>
		         			<tbody>
		         				<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>材料名称:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='reportTitle' name='reportTitle' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>提交部门:</label></td>
									<td width='180'>
									<input type='text' id='reportDept' name='reportDept' class='easyui-textbox'></td>
									<td width='120' style='text-align:right;'><label class='in_label'>提交人:</label></td>
									<td width='180'>
										<input type='text' id='reportSubmitter' name='reportSubmitter' class='easyui-textbox'>
										<a id="a_reportSubmitter" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"reportSubmitter","")'>选择</a>
										<input type='hidden' id='reportSubmitterId' name='reportSubmitterId'>
									</td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label' id='reportTimeId'>提交时间:</label></td>
									<td width='180'>
									<input type='text' id='reportTime' name='reportTime' class='easyui-datebox'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='reportRemarks' name='reportRemarks'
