...
<%
	String cooperationType=(String)request.getAttribute("cooperationType");
 %>
...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/fcCooperationList.js"></script>
<!-- 分页 -->
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"  style="overflow: hidden">
		  ...
		  <!-- 用户角色 -->
			...
			<input type="hidden" id="baseInfoName2" value="${accountInfo.baseInfoName}" />
		  	<!-- 合作类型（0.国内1.国际） -->
		  	<input type="hidden" id="cooperationType1" value="<%=cooperationType%>"/>
		  	<!-- 信息删除状态(当刚进列表时:baseInfoDel=1,点击"删除"按钮,改变数据库状态;当点击回收站后:baseInfoDel=2,点击"删除"按钮,彻底删除数据) -->
		    <input type="hidden" id="cooperationDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'cooperationProjectName'">项目名称</div>
						<div data-options="name:'cooperationCompany'">合作单位</div>
						<div data-options="name:'cooperationTime'">合作时间</div>
						<div data-options="name:'cooperationPersonLiable'">负责人</div>
						<div data-options="name:'cooperationPerson'">合作者</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none">
         		<input type="text" id="cooperationId" name="cooperationId">
         		<!-- 存放选择人员的文本框名称 -->
	         	<input type="text" id="name">
         	</span>
         	<!-- 合作类型 -->
         	<span style="display: none"><input type="text" id="cooperationType" name="cooperationType"></span>
         	<!-- 用来判断是弹窗是新增还是编辑 -->
	         	...
	         	<div id="ListForm" class="ListForm" style="text-align:left; width:95%;margin:0px auto; ">
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			<table id="Staff1" class="StaffInfo">
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>合作项目名称:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='cooperationProjectName' name='cooperationProjectName' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>合作内容:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='cooperationContent' name='cooperationContent' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>合作单位:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='cooperationCompany' name='cooperationCompany' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>合作时间:</label></td>
									<td width='180'>
									<input type='text' id='cooperationTime' name='cooperationTime' class='easyui-datebox'></td>
									<td width='120' style='text-align:right;'><label class='in_label'>合作者:</label></td>
									<td width='180'>
									<input type='text' id='cooperationPerson' name='cooperationPerson' class='easyui-textbox'>
									</td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>所属单位:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='cooperationPersonCompany' name='cooperationPersonCompany' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>负责人:</label></td>
									<td width='180'>
										<input type='text' id='cooperationPersonLiable' name='cooperationPersonLiable' class='easyui-textbox'>
										<a id="a_cooperationPersonLiable" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"cooperationPersonLiable","")'>选择</a>
										<input type='hidden' id='cooperationPersonLiableId' name='cooperationPersonLiableId'/>
									</td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='cooperationRemarks' name='cooperationRemarks'
