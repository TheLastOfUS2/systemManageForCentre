...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/pcTeachingList.js"></script>
<!-- 分页 -->
	...
	<table id="dg" title="授课信息列表"
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"  style="overflow: hidden">
		  ...
		  <!-- 用户角色 -->
		    ...
		    <input type="hidden" id="teachingDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'teachingName'">授课人</div>
						<div data-options="name:'teachingTitle'">课程名称</div>
						<div data-options="name:'teachingHour'">授课课时</div>
						<div data-options="name:'teachingYear'">年度</div>
						<div data-options="name:'teachingTerm'">学期</div>
						<div data-options="name:'teachingType'">授课类型</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none">
         		<input type="text" id="teachingId" name="teachingId">
         		<!-- 存放选择人员的文本框名称 -->
	         			...
	         			<table id="Staff1" class="StaffInfo">
	         				<tbody>
	         					<tr>
									...
									<input type='text' id='teachingTitle' name='teachingTitle' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'>
										<label class='in_label'>授课人:</label>
									</td>
									<td width='180'>
										<input type='text' id='teachingName' name='teachingName' class='easyui-textbox'>
										<a id="a_teachingName" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"teachingName","")'>选择</a>
										<input type='hidden' id='teachingNameId' name='teachingNameId'>
									</td>
									<td width='120' style='text-align:right;'><label class='in_label'>授课类型:</label></td>
									<td width='180'>
									<select id='teachingType' class='easyui-combobox' name='teachingType' panelMaxHeight='100px'>
						         	<option value=''>请选择</option><option value='0'>博士</option><option value='1'>硕士</option><option value='2'>本科</option></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>年度:</label></td>
									<td width='180'>
									<input type='text' class='easyui-combobox ui-text' name='teachingYear' id='yearChoose1' ></td>
									<td width='120' style='text-align:right;'><label class='in_label'>学期:</label></td>
									<td width='180'>
									<select id='teachingTerm' class='easyui-combobox' name='teachingTerm' panelMaxHeight='100px'>
						         	<option value=''>请选择</option><option value='0'>第一学期</option><option value='1'>第二学期</option></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>授课课时:</label></td>
									<td width='180'>
									<input class='easyui-numberspinner' id='teachingHour' name='teachingHour' style='width:139px'  data-options='min:0,max:10000'/></td>
									<td width='120' style='text-align:right;'><label class='in_label'>指导学生年级:</label></td>
									<td width='180'>
									<input type='text' name='teachingStudentGrade' class='easyui-combobox ui-text' id='yearChoose2'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>指导学生姓名:</label><span style="color: red">（用逗号隔开）</span></td>
									<td width='180' colspan='3'>
										<input type='text' id='teachingStudentName' name='teachingStudentName' class='easyui-textbox' style='width:448px'>
										<a href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"teachingStudentName","")'>选择</a>
									</td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='teachingRemarks' name='teachingRemarks'
