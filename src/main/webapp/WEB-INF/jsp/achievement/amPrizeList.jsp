...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/amPrizeList.js"></script>
<!-- 分页 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'prizeTitle'">成果名称</div>
						<div data-options="name:'prizeWay'">成果形式</div>
						<div data-options="name:'baseInfoName'">作者</div>
						<div data-options="name:'prizeAchievement'">奖励名称</div>
						<div data-options="name:'prizeGrade'">获奖等级</div>
						<div data-options="name:'prizeLevel'">奖励级别</div>
						<div data-options="name:'prizeAwardCompany'">颁奖单位</div>
						<div data-options="name:'prizeWinningTime'">颁奖时间</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
		 	<div ><h2 style="border-bottom:1px solid #999">基本信息</h2></div>
		        <form id="fm" method="post">
			        <!-- 基本信息id -->
		         	<span style="display: none"><input type="text" id="prizeId" name="prizeId"></span>
		         	<!-- 用来判断是弹窗是新增还是编辑 -->
		         				...
		         				<tbody>
		         					<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>成果名称:</label>
										</td>
										<td width='180' colspan='3'>
											<input type='text' id='prizeTitle' name='prizeTitle' class='easyui-textbox' style='width:448px'>
										</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>奖励名称:</label>
										</td>
										<td width='180' colspan='3'>
											<input type='text' id='prizeAchievement' name='prizeAchievement' class='easyui-textbox' style='width:448px'>
										</td>
									</tr>
										<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>颁奖单位:</label>
										</td>
										<td width='180' colspan='3'>
											<input type='text' id='prizeAwardCompany' name='prizeAwardCompany' class='easyui-textbox' style='width:448px'>
										</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>获奖时间:</label>
										</td>
										<td width='180'>
											<input type='text' id='prizeWinningTime' name='prizeWinningTime' class='easyui-datebox'>
										</td>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>获奖等级:</label>
										</td>
										<td width='180'>
											<select id='prizeGrade' class='easyui-combobox' name='prizeGrade' panelMaxHeight='100px'>
								         	<option value=''>请选择</option><option value='0'>一</option><option value='1'>二</option>
								         	<option value='2'>三</option><option value='3'>优秀</option><option value='4'>其他</option></select>
							         	</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>颁奖级别:</label>
										</td>
										<td width='180'>
											<select id='prizeLevel' class='easyui-combobox' name='prizeLevel' panelMaxHeight='100px'>
								         	<option value=''>请选择</option><option value='0'>国家</option><option value='1'>部级</option>
								         	<option value='2'>省级</option><option value='4'>省级以下</option></select></td>
							         	<td width='120' style='text-align:right;'>
							         		<label class='in_label'>成果形式:</label>
							         	</td>
										<td width='180'>
											<select id='prizeWay' class='easyui-combobox' name='prizeWay' panelMaxHeight='100px'>
								         	<option value=''>请选择</option><option value='0'>著作</option><option value='1'>论文</option>
								         	<option value='2'>咨询报告</option><option value='3'>研究报告</option><option value='4'>音像软件</option>
								         	<option value='5'>工具书或参考书</option><option value='6'>其他</option></select>
							         	</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>作者:</label>
										</td>
										<td width='180'>
									...
									<tr>
										<td width='120' style='text-align:right;'>
							         	...
							         	<td width='180' colspan='3'>
								         	<input type='text' data-options='multiline:true' id='prizeRemarks' name='prizeRemarks'
