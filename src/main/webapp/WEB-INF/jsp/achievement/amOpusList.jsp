...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/amOpusList.js"></script>
<!-- 分页 -->
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0"
	    toolbar="#dlg-toolbar"   style="overflow: hidden">
		  ...
		  <div style="display: block">
		  	 <!-- 用户角色 -->
			  <input type="hidden"  id="role" value="${accountInfo.roleName}" ></input>
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'opusName'">著作名称</div>
						<div data-options="name:'opusType'">著作类型</div>
						<div data-options="name:'baseInfoName'">第一作者</div>
						<div data-options="name:'opusPublishTime'">出版时间</div>
						<div data-options="name:'opusLanguages'">语种</div>
						<div data-options="name:'opusPublishCompany'">出版单位</div>
						<div data-options="name:'opusSupportTopic'">支持课题</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
		 	<div ><h2 style="border-bottom:1px solid #999">基本信息</h2></div>
		        <form id="fm" method="post">
			        <!-- 基本信息id -->
		         	<span style="display: none"><input type="text" id="opusId" name="opusId"></span>
		         	<!-- 用来判断是弹窗是新增还是编辑 -->
		         				...
		         				<tbody>
		         					<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>著作名称:</label>
										</td>
										<td width='180' colspan='3'>
											<input type='text' id='opusName' name='opusName' class='easyui-textbox' style='width:447px'>
										</td>
										</tr>
									<tr>
										<td width='120' style='text-align:right;'>
										...
										<td width='120' style='text-align:right;'>
											<label class='in_label'>著作类型:</label>
										</td>
										<td width='180'> 
											<select id='opusType' class='easyui-combobox' name='opusType' panelMaxHeight='100px'>
							         		<option value=''>请选择</option><option value='0'>专著</option><option value='1'>编著</option>
							         		<option value='2'>译著</option><option value='3'>教材</option><option value='4'>工具书</option>
							         		<option value='5'>普及行出版物</option></select>
							         	</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
										<label class='in_label'>出版时间:</label>
										</td>
										<td width='180'>
										<input type='text' id='opusPublishTime' name='opusPublishTime' class='easyui-datebox'>
										</td>
										<td width='120' style='text-align:right;'><label class='in_label'>语种:</label>
										</td>
										<td width='180'>
										<select id='opusLanguages' class='easyui-combobox' name='opusLanguages' panelMaxHeight='100px'>
							         	<option value=''>请选择</option><option value='0'>中文</option><option value='1'>外文</option></select>
							         	</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'>出版单位:</label>
										</td>
										<td width='180' colspan='3'>
											<input type='text' id='opusPublishCompany' name='opusPublishCompany' class='easyui-textbox'  style='width:448px;'>
										</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
										...
										<td width='180' colspan='3'> 
											<input type='text' id='opusSupportTopic' name='opusSupportTopic' class='easyui-textbox' style='width:448px;'>
										</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
							         	...
							         	<td width='180' colspan='3'>
							         		<input type='text' data-options='multiline:true' id='opusContent' name='opusContent'
									...
									<tr>
										<td width='120' style='text-align:right;'>
							         	...
							         	<td width='180' colspan='3'>
							         		<input type='text' data-options='multiline:true' id='opusRemarks' name='opusRemarks'
							         		class='easyui-textbox' style='width:448px;height: 50px'>
							         	</td>
							         </tr>
		         				</tbody>
