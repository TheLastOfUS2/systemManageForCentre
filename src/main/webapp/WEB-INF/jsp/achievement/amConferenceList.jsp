...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/amConferenceList.js"></script>
<!-- 导出 cjk编码转换 -->
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"   style="overflow: hidden">
		  <thead>
			...
			<input type="hidden" id="baseInfoName2" value="${accountInfo.baseInfoName}" />
		  	...
		  	<input type="hidden" id="conferenceDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'conferenceTitle'">会议名称</div>
						<div data-options="name:'conferenceAddress'">举办地点</div>
						<div data-options="name:'conferenceStartTime'">会议开始时间</div>
						<div data-options="name:'conferenceEndTime'">会议结束时间</div>
						<div data-options="name:'conferenceNature'">会议性质</div>
						<div data-options="name:'conferenceType'">会议类型</div>
						<div data-options="name:'conferenceChairman'">主席</div>
						<div data-options="name:'conferenceImplementChairman'">执行主席</div>
						<div data-options="name:'conferenceName'">姓名</div>
					</div>
            	</td>
			</tr>
		</table>
		         			...
		         			<table id="Staff1" class="StaffInfo">
		         				...
		         				<tbody>
				         			<tr id="type">
										...
										<label class="in_label">会议性质:</label></td>
										<td width="180" colspan="1">
										 	<select id="conferenceNature" class="easyui-combobox" name="conferenceNature" panelMaxHeight="100px">
									...
									<tr>
										<td width='120' style='text-align:right;'><label class='in_label'>会议名称:</label></td>
										<td width='180' colspan='3'>
										<input type='text' style='width:448px' id='conferenceTitle' name='conferenceTitle' class='easyui-textbox'></td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'><label class='in_label'>举办地点:</label></td>
										<td width='180' colspan='3'>
										<input type='text' style='width:448px' id='conferenceAddress' name='conferenceAddress' class='easyui-textbox'></td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'><label class='in_label'>会议开始时间:</label></td>
										<td width='180'>
										<input type='text' id='conferenceStartTime' name='conferenceStartTime' class='easyui-datebox'></td>
										<td width='120' style='text-align:right;'><label class='in_label'>会议结束时间:</label></td>
										<td width='180'>
										<input type='text' id='conferenceEndTime' name='conferenceEndTime' class='easyui-datebox'></td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'><label class='in_label'>会议类型:</label></td>
										<td width='180'>
										<select id='conferenceType' class='easyui-combobox' name='conferenceType' panelMaxHeight='100px'>
							         	<option value=''>请选择</option><option value='0'>国内</option><option value='1'>国际</option></select></td>
							         	
							         	<td id="conferenceIfReadId1" width='120' style='text-align:right;'>
							         		<label class='in_label'>是否大会宣读:</label>
							         	</td>
										<td width='180' id="conferenceIfReadId2">
											<select id='conferenceIfRead' class='easyui-combobox' name='conferenceIfRead' panelMaxHeight='100px'>
							         		<option value=''>请选择</option><option value='0'>否</option><option value='1'>是</option></select>
							         	</td>
							         	<td id="conferenceChairman1" width='120' style='text-align:right;'><label class='in_label'>主席:</label></td>
										<td width='180' id="conferenceChairman2">
											<input type='text' id='conferenceChairman' name='conferenceChairman' class='easyui-textbox'>
											<a href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"conferenceChairman","")'>选择</a>
											<input type='hidden' id='conferenceChairmanId' name='conferenceChairmanId'>
										</td>
									</tr>
									<tr id="conferenceImplementChairman1">
							         	<td width='120' style='text-align:right;'><label class='in_label'>执行主席:</label></td>
										<td width='180'>
											<input type='text' id='conferenceImplementChairman' name='conferenceImplementChairman' class='easyui-textbox'>
											<a href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"conferenceImplementChairman","")'>选择</a>
											<input type='hidden' id='conferenceImplementChairmanId' name='conferenceImplementChairmanId'>
										</td>
										<td width='120' style='text-align:right;'><label class='in_label'>国内参会人员:</label></td>
										<td width='180'>
										<input class='easyui-numberspinner' id='conferenceDomesticCount' name='conferenceDomesticCount' style='width:139px'  data-options='min:0,max:10000'/></td>
									</tr>
									<tr id="conferenceInternationCountId">
										<td width='120' style='text-align:right;'><label class='in_label'>国际参会人员:</label></td>
										<td width='180'>
										<input class='easyui-numberspinner' id='conferenceInternationCount' name='conferenceInternationCount' style='width:139px' data-options='min:0,max:10000'/></td>
										<td width='120' style='text-align:right;'><label class='in_label'>收录论文数:</label></td>
										<td width='180'>
										<input class='easyui-numberspinner' id='conferencePaperCount' name='conferencePaperCount' style='width:139px' data-options='min:0,max:10000'/></td>
									</tr>
									<tr id="conferenceIfIncludeId">
										<td width='120' style='text-align:right;'><label class='in_label'>是否收录会议论文集:</label></td>
										<td width='180'>
										<select id='conferenceIfInclude' class='easyui-combobox' name='conferenceIfInclude' panelMaxHeight='100px'>
										...
										<td width='180'>
											<input type='text' id='conferenceName' name='conferenceName' class='easyui-textbox'>
											<a id="a_conferenceName" href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' onclick='searchByType(0,"conferenceName","")'>选择</a>
											<input type='hidden' id='conferenceNameId' name='conferenceNameId'>
										</td>
									</tr>
						         	<tr id="conferencePaperNameId">
										<td width='120' style='text-align:right;'><label class='in_label'>交流论文名称:</label></td>
							         	<td width='180' colspan='3'>
							         	<input type='text' data-options='multiline:true' id='conferencePaperName' name='conferencePaperName'
							         	class='easyui-textbox' style='width:448px;'></td>
						         	</tr>
						         	<tr id="conferenceContentId">
										<td width='120' style='text-align:right;'><label class='in_label'>主要活动内容:</label></td>
							         	<td width='180' colspan='3'>
							         	<input type='text' data-options='multiline:true' id='conferenceContent' name='conferenceContent'
							         	class='easyui-textbox' style='width:448px;height: 50px'></td>
						         	</tr>
						         	<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label' id="conferenceSynopsisId">会议综述或简介:</label>
										</td>
							         	<td width='180' colspan='3'>
							         	<input type='text' data-options='multiline:true' id='conferenceSynopsis' name='conferenceSynopsis'
							         	class='easyui-textbox' style='width:448px;height: 50px'></td>
							        </tr>
									<tr>
										<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
							         	<td width='180' colspan='3'>
							         	<input type='text' data-options='multiline:true' id='conferenceRemarks' name='conferenceRemarks'
							         	class='easyui-textbox' style='width:448px;height: 50px'></td>
						         	</tr>
		         				</tbody>
		         				<!-- 论文类型 -->
