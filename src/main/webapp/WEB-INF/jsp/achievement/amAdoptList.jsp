...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/achievement/amAdoptList.js"></script>
<!-- 分页 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'adoptName'">报告名称</div>
						<div data-options="name:'baseInfoName'">作者</div>
						<div data-options="name:'adoptWay'">成果形式</div>
						<div data-options="name:'adoptSubmitTime'">提交时间</div>
						<div data-options="name:'adoptTime'">采纳时间</div>
						<div data-options="name:'adoptCompany'">采纳单位</div>
						<div data-options="name:'adoptPublication'">采纳刊物</div>
						<div data-options="name:'adoptSupportTopic'">支持课题</div>
					</div>
            	</td>
			</tr>
		</table>
	...
	<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
		 <div style="margin: 13px;">
	        ...
	        <form id="fm" method="post">
		        <!-- 基本信息id -->
	         	<span style="display: none"><input type="text" id="adoptId" name="adoptId"></span>
	         	<!-- 用来判断是弹窗是新增还是编辑 -->
	         	...
	         	<div id="ListForm" class="ListForm" style="text-align:left; width:95%;margin:0px auto; ">
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			<table id='Staff1' class='StaffInfo'>
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>报告名称:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='adoptName' name='adoptName' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>支持课题:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='adoptSupportTopic' name='adoptSupportTopic' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>作者:</label></td>
									<td width='180'>
									...
									<td width='120' style='text-align:right;'><label class='in_label'>成果形式:</label></td>
									<td width='180'> 
									<select id='adoptWay' class='easyui-combobox' name='adoptWay' panelMaxHeight='100px'>
						         	<option value=''>请选择</option><option value='0'>采纳</option><option value='1'>批示</option>
						         	<option value='2'>刊发</option></select></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>提交时间:</label></td>
									<td width='180'>
									<input type='text' id='adoptSubmitTime' name='adoptSubmitTime' class='easyui-datebox'></td>
									<td width='120' style='text-align:right;'><label class='in_label'>采纳时间:</label></td>
									<td width='180'>
									<input type='text' id='adoptTime' name='adoptTime' class='easyui-datebox'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>采纳刊物:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='adoptPublication' name='adoptPublication' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>采纳单位:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='adoptCompany' name='adoptCompany' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>批示、鉴定或评价:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='adoptEvaluate' name='adoptEvaluate'
								...
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='adoptRemarks' name='adoptRemarks'
						         	class='easyui-textbox' style='width:448px;height: 50px'></td>
					         	</tr>
	         				</tbody>
	         			</table>
								...
								<tr>
									...
									<td>
										<select id="fileType" name="fileType" style="padding: 3px;border: 1px solid #BDC7D8;">
											...
											<option value="0">成果全文或首页及批示页</option>
