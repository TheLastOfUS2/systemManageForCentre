...
<%	
	//获取共享文件类型(0.工作论文1.研讨会讲稿2.参考文献3.会议通讯录4.其他)
	String shareFileType=(String)request.getAttribute("shareFileType");
 %>
<html>
<head>
<base href="${basePath}" />
...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/sharefile/sfShareFileList.js"></script>
<!-- 分页 -->
...
<body style="overflow-x : hidden;  overflow-y : hidden; ">
	...
	<table id="dg"
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"   style="overflow: hidden">
		  <thead>
		  <input type="hidden" id="shareFileType1" value="<%=shareFileType%>"/>
		  <input type="hidden" id="shareFileDel"/>
		  <input type="hidden" id="baseInfoId" value="${accountInfo.baseInfoId}" />
		  <input type="hidden" id="baseInfoName" value="${accountInfo.baseInfoName}" />
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'shareFileName'">文件名称</div>
						<div data-options="name:'shareFileSubmitter'">提交人</div>
					</div>
            	</td>
			</tr>
		</table>
		 ...
		 <div style="margin: 13px;">
		 	<div ><h2 style="border-bottom:1px solid #999">基本信息</h2></div>
		        <form id="fm" method="post">
			        <!-- 基本信息id -->
		         	<span style="display: none"><input type="text" id="shareFileId" name="shareFileId"></span>
		         	<span style="display: none"><input type="text" name="shareFileType" id="shareFileType"></span>
		         	<!-- 用来判断是弹窗是新增还是编辑 -->
	         		<span style="display: none"><input type="text" id="shareFilePath"></span>
		         				...
		         				<tbody>
		         					<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'><span style="width: 5px;color:red">*</span>文件名称:</label>
										</td>
										<td width='180' colspan='3'>
											<input type='text' id='shareFileName' name='shareFileName' class='easyui-textbox' style='width:447px' required="true">
										</td>
										</tr>
									<tr>
										<td width='120' style='text-align:right;'>
											<label class='in_label'><span style="width: 5px;color:red">*</span>提交人:</label>
										</td>
										<td width='180'  colspan='3'>
											<input type='text' id='shareFileSubmitter1' name='shareFileSubmitter' class='easyui-textbox' style="width:448px;" required="true">
											<input type='hidden' id='shareFileSubmitterId' name='shareFileSubmitterId'/>
										</td>
									</tr>
									<tr>
										<td width='120' style='text-align:right;'>
							         	...
							         	<td width='180' colspan='3'>
							         		<input type='text' data-options='multiline:true' id='shareFileRemarks' name='shareFileRemarks'
