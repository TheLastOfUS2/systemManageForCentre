...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/management/mwFundList.js"></script>
<!-- 分页 -->
...
<body style="overflow-x : hidden;  overflow-y : hidden; ">
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'fundTitle'">经费名称</div>
						<div data-options="name:'fundTime'">划拨时间</div>
						<div data-options="name:'fundType'">经费类别</div>
						<div data-options="name:'fundSource'">经费来源</div>
					</div>
            	</td>
			</tr>
		</table>
	...
	<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none"><input type="text" id="fundId" name="fundId"></span>
         	<!-- 用来判断是弹窗是新增还是编辑 -->
