...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/management/mwBudgetList.js"></script>
<!-- 分页 -->
...
<body style="overflow-x : hidden;  overflow-y : hidden; ">
	...
	<table id="dg" title="年度预算列表"
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"  style="overflow: hidden">
		  <thead>
		    ...
		    <input type="hidden" id="budgetDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'budgetYear'">预算年度</div>
						<div data-options="name:'budgetTime'">制定时间</div>
						<div data-options="name:'budgetCategory'">支出类目</div>
						<div data-options="name:'budgetTitle'">分项名称</div>
						<div data-options="name:'budgetFundSource'">经费来源</div>
					</div>
            	</td>
			</tr>
		</table>
	...
	<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none"><input type="text" id="budgetId" name="budgetId"></span>
         	<!-- 用来判断是弹窗是新增还是编辑 -->
