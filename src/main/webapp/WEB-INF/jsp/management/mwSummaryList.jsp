...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/management/mwSummaryList.js"></script>
<!-- 分页 -->
...
<body style="overflow-x : hidden;  overflow-y : hidden; ">
	...
	<table id="dg" title="基地总结列表"
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0"  toolbar="#dlg-toolbar" style="overflow: hidden">
		  <thead>
			  ...
			  <input type="hidden" id="summaryDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
						<div data-options="name:'summaryTitle'">总结标题</div>
						<div data-options="name:'summaryTime'">撰写时间</div>
						<div data-options="name:'summaryCycle'">总结周期</div>
					</div>
            	</td>
			</tr>
		</table>
	...
	<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
         	<span style="display: none"><input type="text" id="summaryId" name="summaryId"></span>
         	<!-- 用来判断是弹窗是新增还是编辑 -->
