...
<!-- 本页js -->
<script type="text/javascript" src="resources/js/centralactivity/caCentralActivityList.js"></script>
<!-- 分页 -->
...
<body style="overflow-x : hidden;  overflow-y : hidden; ">
	...
	<table id="dg" 
	   ...
	   iconCls: 'icon-save', border: true,pagination: true,collapsible: false,pageSize:30, scrollbarSize :0" toolbar="#dlg-toolbar"  style="overflow: hidden">
		  <thead>
		  	  <input type="hidden" id="activityType1" value="<%=activityType%>"/>
		  	  <!-- 信息删除状态(当刚进列表时:baseInfoDel=1,点击"删除"按钮,改变数据库状态;当点击回收站后:baseInfoDel=2,点击"删除"按钮,彻底删除数据) -->
		      <input type="hidden" id="activityDel"/>
		  </thead> 
	</table>
	<!-- 基本信息列表 -->
		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
            			<!-- 工会 -->
						<div data-options="name:'activityTheme'">主题</div>
						<div data-options="name:'activityTime'">时间</div>
						<div data-options="name:'activityAddress'">地点</div>
						<div id="hId1" data-options="name:'activityHost'">主持人</div>
						<div id="sId" data-options="name:'activitySpeaker'">主讲人</div>
						
						<!-- 党员/其他 -->
						<div id="hId2" data-options="name:'activitySpeaker'">组织者</div>
					</div>
            	</td>
			</tr>
		</table>
	...
	<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
		 <div style="margin: 13px;">
	        ...
	        <!-- 基本信息id -->
        	<span style="display: none"><input type="text" id="activityId" name="activityId"></span>
        	<!-- 基本信息类型 -->
         	<span style="display: none"><input type="text" name="activityType" id="activityType"></span>
         	<!-- 用来判断是弹窗是新增还是编辑 -->
	         	...
	         	<div id="ListForm" class="ListForm" style="text-align:left; width:95%;margin:0px auto; ">
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			<table id="Staff1" class="StaffInfo">
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>主题:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activityTheme' name='activityTheme' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>地点:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activityAddress' name='activityAddress' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>时间:</label></td>
									<td width='180'>
									<input type='text' id='activityTime' name='activityTime' class='easyui-datebox'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label' id='activitySpeakerId'>主讲人:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activitySpeaker' name='activitySpeaker' class='easyui-textbox'  style='width:448px'></td>
									</tr>
									<tr id='activityHostTr'>
									<td width='120' style='text-align:right;'><label class='in_label'>主持人:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activityHost' name='activityHost' class='easyui-textbox'  style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>参加人:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='activityParticipant' name='activityParticipant' class='easyui-textbox' style='width:448px'></td>
									</tr>
									<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>主要内容:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='activityContent' name='activityContent'
									...
									<td width='120' style='text-align:right;'><label class='in_label'>备注:</label></td>
						         	<td width='180' colspan='3'>
						         	<input type='text' data-options='multiline:true' id='activityRemarks' name='activityRemarks'
						         	class='easyui-textbox' style='width:448px;height: 50px'></td>
						         	</tr>
	         				</tbody>
	         			</table>
					...
					<div>
						<table class="f-table">
							<thead>
								...
								<tr>
									<td width="20%">文件类别</td>
									<td id="typeActivity0" style="display: none">
										<select id="fileType" name="fileType" style="padding: 3px;border: 1px solid #BDC7D8;">
										    <option value="">请选择文件类别</option>
											<option value="0">其他</option>
										</select>
									</td>
									<td id="typeActivity1" style="display: none">
										<select id="fileType" name="fileType" style="padding: 3px;border: 1px solid #BDC7D8;">
										    <option value="">请选择文件类别</option>
											<option value="0">其他</option>
										</select>
									</td>
									<td id="typeActivity2" style="display: none">
										<select id="fileType" name="fileType" style="padding: 3px;border: 1px solid #BDC7D8;">
										    <option value="">请选择文件类别</option>
											<option value="0">相关文件</option>
											<option value="1">文字材料</option>
											<option value="2">音像资料</option>
											<option value="4">其他</option>
										</select>
									</td>
									<td id="typeActivity3" style="display: none">
										<select id="fileType" name="fileType" style="padding: 3px;border: 1px solid #BDC7D8;">
										    <option value="">请选择文件类别</option>
											<option value="0">其他</option>
										</select>
